...
<body class="meu-body">
    ...
    <div class="meu-container">
        ...
        <!-- INICIO CONEXÃO COM O BANCO DE DADOS E REALIZAÇÃO DA CONSULTA NA TABELA -->
        <?php
        require("conexaobd.php");
        $consulta = "select IDLABORATORIO as idLaboratorio, NOME as nomeLaboratorio from laboratorio order by NOME;";
        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    <th scope="col">Código / ID - Laboratório</th>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="laboratorio.php?idLaboratorio=<?php echo $idLaboratorio; ?>">
                        ...
                        <td>
                            <a href="excluirlaboratorio.php?idLaboratorio=<?php echo $idLaboratorio; ?>">
