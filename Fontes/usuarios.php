...
<body class="meu-body">
    ...
    <div class="meu-container">
        ...
        <!-- INICIO CONEXÃO COM O BANCO DE DADOS E REALIZAÇÃO DA CONSULTA NA TABELA DE USUARIOS -->
        <?php
        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    <th scope="col">Código / ID - Usuários</th>
                    <th scope="col">Nome do Usuários</th>
                    <th scope="col">Tipo do Usuários</th>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="excluirUsuario.php?idUsuario=<?php echo $idUsuario; ?>">
